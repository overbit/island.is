...
import { GetOrganizationSupportCategoriesInput } from './dto/getOrganizationSupportCategories.input'
...
export class CmsResolver {
  ...
  getOrganizationSupportCategories (
    @Args('input') input: GetOrganizationSupportCategoriesInput,
  ): Promise<SupportCategory[]> {
    return this.cmsContentfulService.getOrganizationSupportCategories(input)
  }
